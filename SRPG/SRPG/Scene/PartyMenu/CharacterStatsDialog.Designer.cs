...
{
    public partial class CharacterStatsDialog : InventoryWindowControl
    {
        ...
        private void InitializeComponent()
        {
            ...
            _defLabel.Bounds = new UniRectangle(
                new UniScalar(0), new UniScalar(1 / (2 * n), -12.5f),
            ...
            _defText.Bounds = new UniRectangle(
                new UniScalar(0, 50), new UniScalar(1 / (2 * n), -12.5f),
                new UniScalar(0.0F, 50.0F), new UniScalar(0.0F, 25.0F)
                );
            ...
            _defProg.Bounds = new UniRectangle(
                new UniScalar(0, 100), new UniScalar(0, 10),
                new UniScalar(1.0F, -150.0F), new UniScalar(1f / n, -20.0F)
            );
            ...
            _defLevel.Bounds = new UniRectangle(
                new UniScalar(1, -45), new UniScalar(1 / (2 * n), -12.5f),
                new UniScalar(0.0F, 50.0F), new UniScalar(0.0F, 25.0F)
                );
            _defLevel.Text = "1";
            ...
            _attLabel.Bounds = new UniRectangle(
                new UniScalar(0), new UniScalar(3 / (2 * n), -12.5f),
                new UniScalar(0.0F, 50.0F), new UniScalar(0.0F, 25.0F)
                );
            _attLabel.Text = "ATT";
            ...
            _attText.Bounds = new UniRectangle(
                new UniScalar(0, 50), new UniScalar(3 / (2 * n), -12.5f),
                new UniScalar(0.0F, 50.0F), new UniScalar(0.0F, 25.0F)
                );
            ...
            _attProg.Bounds = new UniRectangle(
                new UniScalar(0, 100), new UniScalar(1f / n, 10),
                new UniScalar(1.0F, -150.0F), new UniScalar(1f / n, -20.0F)
            );
            ...
            _attLevel.Bounds = new UniRectangle(
                new UniScalar(1, -45), new UniScalar(3 / (2 * n), -12.5f),
                new UniScalar(0.0F, 50.0F), new UniScalar(0.0F, 25.0F)
                );
            _attLevel.Text = "1";
            ...
            _wisLabel.Bounds = new UniRectangle(
                new UniScalar(0), new UniScalar(5 / (2 * n), -12.5f),
                new UniScalar(0.0F, 50.0F), new UniScalar(0.0F, 25.0F)
                );
            _wisLabel.Text = "WIS";
            ...
            _wisText.Bounds = new UniRectangle(
                new UniScalar(0, 50), new UniScalar(5 / (2 * n), -12.5f),
                new UniScalar(0.0F, 50.0F), new UniScalar(0.0F, 25.0F)
                );
            ...
            _wisProg.Bounds = new UniRectangle(
                new UniScalar(0, 100), new UniScalar(2f / n, 10),
                new UniScalar(1.0F, -150.0F), new UniScalar(1f / n, -20.0F)
            );
            ...
            _wisLevel.Bounds = new UniRectangle(
                new UniScalar(1, -45), new UniScalar(5 / (2 * n), -12.5f),
                new UniScalar(0.0F, 50.0F), new UniScalar(0.0F, 25.0F)
                );
            _wisLevel.Text = "1";
            ...
            _intLabel.Bounds = new UniRectangle(
                new UniScalar(0), new UniScalar(7 / (2 * n), -12.5f),
                new UniScalar(0.0F, 50.0F), new UniScalar(0.0F, 25.0F)
                );
            _intLabel.Text = "INT";
            ...
            _intText.Bounds = new UniRectangle(
                new UniScalar(0, 50), new UniScalar(7 / (2 * n), -12.5f),
                new UniScalar(0.0F, 50.0F), new UniScalar(0.0F, 25.0F)
                );
            ...
            _intProg.Bounds = new UniRectangle(
                new UniScalar(0, 100), new UniScalar(3f / n, 10),
                new UniScalar(1.0F, -150.0F), new UniScalar(1f / n, -20.0F)
            );
            ...
            _intLevel.Bounds = new UniRectangle(
                new UniScalar(1, -45), new UniScalar(7 / (2 * n), -12.5f),
                new UniScalar(0.0F, 50.0F), new UniScalar(0.0F, 25.0F)
                );
            _intLevel.Text = "1";
            ...
            _spdLabel.Bounds = new UniRectangle(
                new UniScalar(0), new UniScalar(9 / (2 * n), -12.5f),
                new UniScalar(0.0F, 50.0F), new UniScalar(0.0F, 25.0F)
                );
            _spdLabel.Text = "SPD";
            ...
            _spdText.Bounds = new UniRectangle(
                new UniScalar(0, 50), new UniScalar(9 / (2 * n), -12.5f),
                new UniScalar(0.0F, 50.0F), new UniScalar(0.0F, 25.0F)
                );
            ...
            _spdProg.Bounds = new UniRectangle(
                new UniScalar(0, 100), new UniScalar(4f / n, 10),
                new UniScalar(1.0F, -150.0F), new UniScalar(1f / n, -20.0F)
            );
            ...
            _spdLevel.Bounds = new UniRectangle(
                new UniScalar(1, -45), new UniScalar(9 / (2 * n), -12.5f),
                new UniScalar(0.0F, 50.0F), new UniScalar(0.0F, 25.0F)
                );
            _spdLevel.Text = "1";
            ...
            _hitLabel.Bounds = new UniRectangle(
                new UniScalar(0), new UniScalar(11 / (2 * n), -12.5f),
                new UniScalar(0.0F, 50.0F), new UniScalar(0.0F, 25.0F)
                );
            _hitLabel.Text = "HIT";
            ...
            _hitText.Bounds = new UniRectangle(
                new UniScalar(0, 50), new UniScalar(11 / (2 * n), -12.5f),
                new UniScalar(0.0F, 50.0F), new UniScalar(0.0F, 13.0F)
                );
            ...
            _hitProg.Bounds = new UniRectangle(
                new UniScalar(0, 100), new UniScalar(5f / n, 10),
                new UniScalar(1.0F, -150.0F), new UniScalar(1f / n, -20.0F)
            );
            ...
            _hitLevel.Bounds = new UniRectangle(
                new UniScalar(1, -45), new UniScalar(11 / (2 * n), -12.5f),
                new UniScalar(0.0F, 50.0F), new UniScalar(0.0F, 25.0F)
                );
            _hitLevel.Text = "1";
