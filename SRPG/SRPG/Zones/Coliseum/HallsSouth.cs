...
namespace SRPG.Zones.Coliseum
{
    class HallsSouth : Zone
    {
        public HallsSouth(Game game, Torch.Object parent) : base(game)
        {
            ...
            Sandbag = Grid.FromBitmap(Game.Services, "Zones/Coliseum/Halls/south-sb");
            ...
            Objects.Add(new InteractiveObject { Interact = SimpleDoor("coliseum/cell", "halls"), Location = new Rectangle(345, 590, 50, 15) });
